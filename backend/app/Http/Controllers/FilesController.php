...
{
const MARKER_URL = 'https://undying-stock-perfected.ngrok-free.dev';
const MODEL_URL  = 'https://botany-symphonic-essential.ngrok-free.dev';
    ...
    public function summarize(Request $request, $id)
    {
        ...
        // 🚨 1. التحقق من نطاق الصفحات (Validation) بنفس أسلوب دالة الأسئلة
        ...
        // ✅ 2. تحديد مصدر البيانات (يفضل المصفوفة المقسمة صفحات أولاً)
        ...
        // ✅ 3. استخراج الصفحات المحددة بناءً على البارامترات الصحيحة القادمة من Flutter
        ...
        if (empty(trim($rawText))) {
            return response()->json(['success' => false, 'message' => 'No extractable text found within the selected range.'], 422);
        }
    ...
    public function chat(Request $request, $id)
    {
        ...
        // ✅ جيب محتوى الملف من الـ database
        $context = trim($file->extracted_text ?? $file->content ?? $file->text ?? '');
